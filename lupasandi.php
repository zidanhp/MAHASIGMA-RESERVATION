    ...
    <div class="login-container">
      <div class="login-box">
        ...
        <form action="login.php" method="post">
          <input type="text" class="form-control" id="username" placeholder="Kata Sandi Baru" name="username" required>
          <div class="password-wrapper">
            <input type="password" class="form-control" id="password" placeholder="Konfirmasi Kata Sandi Baru" name="password" required>
