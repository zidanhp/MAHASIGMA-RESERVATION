...
$totalPesanan = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM pemesan"))['total'];
$totalSudahBayar = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM pemesan WHERE status_bayar = 'Sudah Bayar'"))['total'];
$totalBelumBayar = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM pemesan WHERE status_bayar = 'Belum Bayar'"))['total'];
$totalBatal = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM pemesan WHERE status_bayar = 'Batal Pesan'"))['total'];
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="row g-0 mt-5">
        ...
        <div class="content flex-grow-1 col-md-10">
            ...
            <div class="card">
                ...
                <div class="card">
                    <h1><?= $totalSudahBayar ?></h1>
                    <p>Sudah Bayar</p>
                </div>
                <div class="card">
                    <h1><?= $totalBelumBayar ?></h1>
                    <p>Belum Bayar</p>
                </div>
                <div class="card">
                    <h1><?= $totalBatal ?></h1>
